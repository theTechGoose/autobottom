...
interface PipelineStats { inPipe?: number; active?: ActiveItem[]; completed24h?: number; completedCount?: number; errors24h?: number; genuineErrors24h?: number; recoveredErrors24h?: number; errors?: ErrorItem[]; retries24h?: number; retries?: unknown[]; completedTs?: number[]; errorsTs?: number[]; retriesTs?: number[]; paused?: boolean; }
...
export default define.page(async function AdminDashboard(ctx) {
  ...
  return (
    <Layout title="Dashboard" section="admin" user={user} gameState={ctx.state.gameState} pathname={new URL(ctx.req.url).pathname}>
      ...
      {[
        ...
        { id: "reports-modal", title: "Reports", sub: "Run reports and preview scheduled emails", endpoint: "/api/admin/modal/reports", className: "maint-modal", noHeader: true },
        { id: "gamification-admin-modal", title: "Gamification Admin", sub: "Browse users, grant XP, award badges", endpoint: "/api/admin/modal/gamification-admin", className: "maint-modal", noHeader: true },
