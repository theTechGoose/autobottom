...
function parseVoName(voNameRaw: string, fallback: string): { full: string; first: string } {
...
// Test-only export: lets the e2e suite invoke the handler directly without
// needing a real Postmark token. Not part of the production surface.
export const __test__ = { sendAuditCompleteEmail, parseVoName, renderTemplate, resolveTemplate };
