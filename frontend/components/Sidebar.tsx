...
const ADMIN_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/admin/email-reports", label: "Email Reports", icon: "mail" },
      { href: "/admin/email-templates", label: "Email Templates", icon: "mail" },
      { href: "/admin/chargebacks-report", label: "Chargebacks", icon: "clipboard-list" },
      { href: "/admin/bad-words", label: "Bad Words", icon: "alert-triangle" },
      { href: "/admin/offices", label: "Offices", icon: "clipboard-list" },
      { href: "/admin/users", label: "Users", icon: "users" },
      { href: "/admin/pipeline", label: "Pipeline", icon: "settings" },
      { href: "/admin/bonus-points", label: "Bonus Points", icon: "trophy" },
      { href: "/admin/dimensions", label: "Dimensions", icon: "bar-chart" },
