/** GET: Load scope editor for a manager. POST: Save scopes. */
...
export const handler = define.handlers({
  ...
  async POST(ctx) {
    ...
    // Re-render the scope editor by redirecting to GET
    const redirectUrl = `/api/admin/modal/users/scopes?email=${encodeURIComponent(email)}`;
    // Return redirect for HTMX
    return Response.redirect(new URL(redirectUrl, url.origin), 303);
  },
});
