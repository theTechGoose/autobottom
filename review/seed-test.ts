...
const FAKE_TRANSCRIPT = `Agent: Thank you for calling Monster Reservations Group, my name is Sarah. How can I help you today?
...
const questions = [
  { header: "Greeting", unpopulated: "Did the agent greet the customer?", populated: "Did the agent greet the customer by name and identify themselves with their name and company?", answer: "Yes", thinking: "Agent said 'Thank you for calling Monster Reservations Group, my name is Sarah. How can I help you today?' — identifies company, gives name, and offers help.", defense: "Clear greeting with agent name (Sarah) and company identification (Monster Reservations Group) at the start of the call." },
